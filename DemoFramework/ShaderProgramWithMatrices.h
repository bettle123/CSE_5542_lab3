...
#include "ShaderConstant_depthModelViewProj.h"
#include "ShaderConstantdepthBiasMVP.h"
	...
	namespace Graphics
	{
		...
		private:
			void AddMatrices()
			{
				...
				ShaderConstantdepthModelViewProj * depthConstant= new ShaderConstantdepthModelViewProj(depthMVPName);
				ShaderConstantdepthBiasMVP * depthBiasMVPConstant = new ShaderConstantdepthBiasMVP(depthBiasMVPName);
				...
				shaderConstants->AddConstant(depthConstant);
				shaderConstants->AddConstant(depthBiasMVPConstant);
		...
		private:
			...
			std::string depthMVPName= "depthMVP";
			std::string depthBiasMVPName = "depthBiasMVP";
